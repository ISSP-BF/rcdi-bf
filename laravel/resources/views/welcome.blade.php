...
<body data-theme="default" data-layout="fluid" data-sidebar-position="left" data-sidebar-layout="default">
                            ...
                            <div>
                                ...
                                <div class="mx-4">
                                    ...
                                    <select class="form-select" id="typeSelect">
                                        ...
                                        <option value="Cabinet de soins">Cabinet de soins</option>
    ...
    <script>
        var map = L.map('map').setView([12.2418505, -1.5567604999999958], 9);
        L.tileLayer('https://tile.openstreetmap.org/{z}/{x}/{y}.png', {
            maxZoom: 20,
            // attribution: '&copy; <a href="http://www.openstreetmap.org/copyright">OpenStreetMap</a>'
        }).addTo(map);

        function inverserCoordonneesPolygons(polygonsData) {
            return polygonsData.map(polygon => ({
                ...polygon,
                coords: polygon.coords.map(([lat, lon]) => [lon, lat])
            }));
        }
        var polygonsData = [{
                coords: [
            ...
            try {
                ...
                if (response.data.results.length > 0) {
                    ...
                    response.data.results.forEach(result => {
                        ...
                        button.setAttribute('data-bs-target', '#centeredModalPrimary');
                        button.setAttribute('data_result', JSON.stringify(result));
                        ...
                        divContainer.innerHTML = popupContent;
                        divContainer.querySelector('.d-grid').appendChild(button);
