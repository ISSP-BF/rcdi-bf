...
export default {
  ...
  methods: {
    ...
    store() {
        ...
        axios.post(  this.$apiAdress + '/api/indicateurs-old?token=' + localStorage.getItem("api_token"),
          self.indicateur
        )
  ...
  mounted: function(){
    let self = this;
    axios.get(  this.$apiAdress + '/api/indicateurs-old/create?token=' + localStorage.getItem("api_token"))
    .then(function (response) {
